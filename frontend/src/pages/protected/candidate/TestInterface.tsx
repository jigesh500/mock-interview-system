...
interface StartTestProps {
  onExamSubmit?: () => void; // Called to unlock fullscreen after submit
}
...
const StartTest: React.FC<StartTestProps> = ({ onExamSubmit }) => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (response.data.status === "success") {
        ...
        if (onExamSubmit) onExamSubmit(); // unlock fullscreen
  ...
  }, [questions, answers, sessionId, onExamSubmit, allQuestionsAnswered]);
