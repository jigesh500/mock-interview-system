        ...
        return String.format("""
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <p>You have been assigned to conduct a <strong>Personal Interview (PI)</strong> for the following candidate who has successfully passed the technical round:</p>
                    ...
                    <div style="background-color: #d4edda; padding: 15px; border-radius: 5px; margin: 20px 0;">
                        ...
                        <ol>
                            <li>Review the candidate's profile and technical round feedback</li>
                            <li>Prepare behavioral and situational questions</li>
                            <li>Schedule the PI meeting and send calendar invite to the candidate</li>
                            <li>Conduct the personal interview focusing on soft skills</li>
                            <li>Provide final recommendation through the HR system</li>
                        </ol>
                    </div>
